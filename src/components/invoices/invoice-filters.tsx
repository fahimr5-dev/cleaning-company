...
/**
 * Search and filter the invoice list.
 *
 * The filters live in the address bar, so "everything still unpaid" is a link
 * the owner can bookmark rather than a set of clicks they repeat every morning.
 */
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {(["ALL", "UNPAID", "OVERDUE", "PAID", "DRAFT", "VOID"] as const).map((value) => (
          <button
            key={value}
            type="button"
